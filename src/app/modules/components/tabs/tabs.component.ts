...
export class TabsComponent implements OnInit {
  ...
  ngOnInit(): void {
    let limitIndex = 10;
    let offSetIndex = 0;
    this.getFeedArticles(limitIndex,offSetIndex)
...
img1, img2, img3, img4,img5,img6,img7,img8,img9,img10
  ...
  articles:any;
getFeedArticles(limitIndex:number,offSetIndex:number){
  this.service.getFeed(limitIndex,offSetIndex).subscribe((res:any)=>{
   console.log(res);
